...
Embedded in every product (18): #1 Lifecycle Engine, #2 Code Builder, #3 Self-Renewal, #6 Research, #7 Design, #9 GTM, #10 Monitor, #13 Self-Protection, #15 Benchmarking & Competition, #17 Product Evolution, #19 Technological Evolution, #20 Environmental Impacts, #21 Aggressive Crawl Conductor, #22 Finance & Procurement, #23 HR & Compensation, #24 Information Security, #25 Customer Care, #26 Legal & Communications.

Ops Runners embedded (1): #21 Aggressive Crawl Conductor.

Business-advisory agents (5): #22 Finance & Procurement, #23 HR & Compensation, #24 Information Security, #25 Customer Care, #26 Legal & Communications. These rows are embedded and ROSTERED + IMPLEMENTED in `AGENT_REGISTRY` at code base `19c554b`; not WIRED, not RUNTIME_ACTIVE, not PRODUCTION_VERIFIED. Registry mode `step-owner` does not make them §9 Forge-pipeline step owners.
