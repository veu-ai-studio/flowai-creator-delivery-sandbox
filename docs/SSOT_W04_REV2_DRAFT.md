...
4. Three user-facing operating modes: Auto / Guided / Manual (Rev-2 user-facing labels: Auto / Recommended / User-Choice for Orchestra; Hands-On / Reviewed / Hands-Off for System Operation; see §8/§8a).
