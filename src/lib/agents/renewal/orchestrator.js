...
export const FORGE_STEP5_TO_STEP6_TIMEOUTS_MS = Object.freeze({
  ...
  probeAllPages: 25_000,
  probeAdversarialSurface: 25_000,
  runEvaluationPipeline: 35_000,
  getInstallationToken: 8_000,
  fetchRepoFileList: 8_000,
  fetchFileContent: 8_000,
  prioritizeIssuesWithClaude: 15_000,
  generateFix: 20_000,
  construction: 20_000,
  remediation: 20_000,
