...
describe('FlowAI public domain constants', () => {
  it('defines the renewed canonical product URL while preserving the legacy URL', () => {
    expect(FLOWAI_CANONICAL_DOMAIN).toBe('flowai.flowaiplatform.com');
    expect(FLOWAI_CANONICAL_URL).toBe('https://flowai.flowaiplatform.com');
  ...
  it('provides the GTM demo link for SAIGE live proof', () => {
    ...
    expect(FLOWAI_GTM_DEMO_URL).toBe(
      'https://flowai.flowaiplatform.com/flowai?url=https%3A%2F%2Fsaigeplatform.com',
    );
  });
  ...
  it('returns a frozen public URL envelope for UI and report consumers', () => {
    ...
    expect(urls).toMatchObject({
      canonicalDomain: 'flowai.flowaiplatform.com',
      canonicalUrl: 'https://flowai.flowaiplatform.com',
